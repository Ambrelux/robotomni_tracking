...
import numpy as np
import cv2
from scripts.tracking_utils import Box, Countdown, which_is_foreground, calculate_iou
...
class Window(Thread):
    def __init__(self, trackers):
        ...
        :type name: Window
        """
        self.img = cv2.imread('../resources/images/Snapshots/test6.jpg')
        self.disp_img = cv2.imread('../resources/images/Snapshots/test6.jpg')
    ...
    def set_first_frame(self, first_frame):
        ...
        Returns:
        set the value of self.first_frame with value passed in argument
        """
