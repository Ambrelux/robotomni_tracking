...
from scripts.detection import get_classes, detect_image
...
class Tracking(Thread):
    ...
    def run(self):
        ...
        f2 = 'test8.jpg'
        path2 = 'resources/images/Snapshots/' + f2
        ...
        while self.threading_event.wait():
            ...
            if time.time() - t_prev > 1:
                ...
                replay_detection = self.door_to_heaven.reliable_tracking(boxes_multi_tracking, image,
                                                                         boxes_yolo_detection)
